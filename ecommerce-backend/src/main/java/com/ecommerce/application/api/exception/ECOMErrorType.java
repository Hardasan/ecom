...
public enum ECOMErrorType {
    ...
    CATEGORY_MAX_DEPTH_EXCEEDED(HttpStatus.BAD_REQUEST, "error.category.max.depth.exceeded"),
    CATEGORY_INVALID_PARENT(HttpStatus.BAD_REQUEST, "error.category.invalid.parent"),
    CATEGORY_HAS_SUBCATEGORIES(HttpStatus.CONFLICT, "error.category.has.subcategories"),
    CATEGORY_IN_USE(HttpStatus.CONFLICT, "error.category.in.use"),
